 ...
 */
const jitteredNow = (): number => Math.round(nowSeconds() - Math.random() * TWO_DAYS);
 ...
 */
export function wrapEventWithRumor(
...
export function expirationTagsOf(tags: string[][]): string[][] {
